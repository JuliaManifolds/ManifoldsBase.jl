...
@testset "AbstractManifold with empty implementation" begin
    ...
    @test_throws MethodError retract_t!(M, p, p, [0.0], 0.0)
    @test_throws MethodError retract_t!(M, p, p, [0.0], 0.0, exp_retr)
    @test_throws MethodError retract!(M, [0], [0], [0])
    @test_throws MethodError retract!(M, [0], [0], [0], exp_retr)
    @test_throws MethodError retract_t!(M, [0], [0], [0], 0.0)
    @test_throws MethodError retract_t!(M, [0], [0], [0], 0.0, exp_retr)
    @test_throws MethodError retract(M, [0], [0])
    @test_throws MethodError retract(M, [0], [0], exp_retr)
    @test_throws MethodError retract_t(M, [0], [0], 0.0)
    @test_throws MethodError retract_t(M, [0], [0], 0.0, exp_retr)
    @test_throws MethodError retract(M, [0.0], [0.0])
    @test_throws MethodError retract(M, [0.0], [0.0], exp_retr)
    @test_throws MethodError retract_t(M, [0.0], [0.0], 0.0)
    @test_throws MethodError retract_t(M, [0.0], [0.0], 0.0, exp_retr)
